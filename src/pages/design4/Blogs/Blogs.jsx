...
const Blogs = () => {
  ...
  return (
    <div className="blogs-page">
        ...
        {blogPosts.map((post, index) => (
          ...
          >
            ...
            <div className="card-content-new">
              ...
              <p className="card-excerpt-new">{post.excerpt}</p>
      ...
      >
        <motion.span className="prev disabled" whileHover={{ x: -4 }}>
          Previous
        </motion.span>
        <span className="page-number">1</span>
        <motion.span className="next" whileHover={{ x: 4 }}>
          Next
        </motion.span>
      </motion.div>
    </div>
